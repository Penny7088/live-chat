...
ThemeData getThemeData(ThemeEnum themeEnum) {
  switch (themeEnum) {
...
ThemeData dartTheme = FlexThemeData.dark(
  scheme: FlexScheme.blue, // 使用蓝色调色板
  surfaceMode: FlexSurfaceMode.levelSurfacesLowScaffold, // 使用低级表面模式和底层脚手架
...
ThemeData defaultTheme =
    WidgetsBinding.instance.platformDispatcher.platformBrightness == Brightness.dark ? dartTheme : lightTheme;
